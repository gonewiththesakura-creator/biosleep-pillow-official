...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ss(){return new Ca({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Cs(){return new Ca({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ws(),fragmentShader:`
	...
	`}var Ts=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function pd(e,t=0,n=1){return Math.min(n,Math.max(t,e))}function md(e){let t=pd(e);return t*t*(3-2*t)}function hd(){let e=document.querySelector(`#pillow-canvas`),n=new lu({canvas:e,alpha:!0,antialias:!0});n.setPixelRatio(Math.min(window.devicePixelRatio,2));let r=new jn,i=new vo(35,1,.1,100);i.position.set(0,.55,6.2),n.outputColorSpace=Re,n.toneMapping=4,n.toneMappingExposure=1.08;let a=new Cn;r.add(a);let o=[],s=new Cn;a.add(s);let c=null,l=new ia(4.1,.78,2.22,72,22,42),u=l.attributes.position;for(let e=0;e<u.count;e++){let t=u.getX(e),n=u.getY(e),r=u.getZ(e),i=Math.max(Math.abs(t)/2.05,Math.abs(r)/1.11),a=Math.exp(-(t*t*.22+r*r*.62)),o=Math.sin((t+2.1)*14)*.01+Math.sin((r+1.3)*18)*.007;u.setY(e,n*(.76+a*.42)-i**3.2*.16+o),u.setX(e,t*(1-(Math.abs(r)/1.5)**4*.04))}l.computeVertexNormals();let d=document.createElement(`canvas`);d.width=256,d.height=256;let f=d.getContext(`2d`);f.fillStyle=`#f7f7f9`,f.fillRect(0,0,256,256);for(let e=0;e<256;e+=5)f.strokeStyle=e%10==0?`rgba(174,174,184,.18)`:`rgba(255,255,255,.26)`,f.beginPath(),f.moveTo(e,0),f.lineTo(e+Math.sin(e)*2,256),f.stroke(),f.beginPath(),f.moveTo(0,e),f.lineTo(256,e+Math.cos(e)*2),f.stroke();let p=new ea(d);p.wrapS=t,p.wrapT=t,p.repeat.set(4,2);let m=new Ea({color:16316667,map:p,bumpMap:p,bumpScale:.035,roughness:.72,metalness:.02,clearcoat:.18,clearcoatRoughness:.82,sheen:1,sheenColor:new X(16777215)}),h=new Zr(l,m);h.rotation.x=-.08,a.add(h),o.push(h);let g=new Mi({color:14079710,transparent:!0,opacity:.34});for(let e of[-1.13,1.13]){let t=new pa([new K(-1.95,.17,e),new K(-.6,.27,e),new K(.7,.27,e),new K(1.95,.15,e)]),n=new Bi(new Tr().setFromPoints(t.getPoints(90)),g);a.add(n),o.push(n)}let _=new Zr(new aa(2.5,96),new zr({color:0,transparent:!0,opacity:.16}));_.rotation.x=-Math.PI/2,_.position.y=-.72,_.scale.z=.36,a.add(_),new pu().load(`/biosleep-pillow-official/models/biosleep-pillow.glb`,e=>{let t=e.scene,n=new Kn().setFromObject(t),r=n.getSize(new K),i=n.getCenter(new K),a=Math.max(r.x,r.y,r.z)||1;t.position.sub(i),t.scale.setScalar(5.05/a),t.rotation.x=-.08,s.add(t),o.forEach(e=>{e.visible=!1}),c=s,window.__pillowModelDebug={loaded:!0,source:`models/biosleep-pillow.glb`,children:t.children.length,generatedFallbackVisible:!1}},void 0,()=>{s.visible=!1,window.__pillowModelDebug={loaded:!1,source:`models/biosleep-pillow.glb`,generatedFallbackVisible:!0}}),r.add(new Eo(16777215,1.65));let v=new To(16777215,2.35);v.position.set(-3,5,5),r.add(v);let y=new To(14214655,1.25);y.position.set(4,1.8,-4),r.add(y);let b={x:0,y:0},x={p:0,pillow:0,corner:0,returnPhase:0,final:0};window.__setPillowScroll=e=>{typeof e==`number`?x.pillow=e:Object.assign(x,e)},window.addEventListener(`pointermove`,e=>{b.x=(e.clientX/window.innerWidth-.5)*2,b.y=(e.clientY/window.innerHeight-.5)*2});function S(){let t=e.getBoundingClientRect();n.setSize(t.width,t.height,!1),i.aspect=t.width/t.height,i.updateProjectionMatrix()}window.addEventListener(`resize`,S),S();function C(e){let t=e*.001,o=x.pillow,s=x.p||0,l=x.corner||0,u=x.returnPhase||0,d=x.final||0,f=o*Math.PI*2.6+l*Math.PI*.85-u*Math.PI*.5-.28;a.rotation.y+=(f+b.x*.08-a.rotation.y)*.045,a.rotation.x+=(-.1+Math.sin(s*Math.PI)*.38+l*.58-u*.36-b.y*.035-a.rotation.x)*.045,a.rotation.z+=((o-.5)*.08-l*.22+u*.18-a.rotation.z)*.04;let p=c||h;p.position.y=Math.sin(t*.9)*.028+l*.1-d*.05,p.position.x+=(l*-.32+u*.16-p.position.x)*.035,p.scale.setScalar(1+l*.18-u*.08),m.roughness=.64+Math.sin(t*.7+s*2)*.035+l*.05,n.render(r,i),requestAnimationFrame(C)}requestAnimationFrame(C)}function gd(){let e=document.querySelector(`#grain`),t=e.getContext(`2d`),n=0,r=0,i=[];function a(){n=e.width=window.innerWidth*devicePixelRatio,r=e.height=window.innerHeight*devicePixelRatio,i=Array.from({length:Math.min(170,Math.floor(window.innerWidth/7))},()=>({x:Math.random()*n,y:Math.random()*r,a:Math.random()*Math.PI*2,s:.35+Math.random()*1.2,l:40+Math.random()*140}))}window.addEventListener(`resize`,a),a();function o(e){t.clearRect(0,0,n,r),t.globalAlpha=.12,t.strokeStyle=`#d8d0c2`,t.lineWidth=devicePixelRatio*.65,i.forEach(r=>{r.a+=.004*r.s,r.x+=Math.cos(r.a)*.16*devicePixelRatio,r.y+=Math.sin(r.a*.7)*.1*devicePixelRatio,r.x<-r.l&&(r.x=n+r.l),r.x>n+r.l&&(r.x=-r.l);let i=Math.sin(e*5e-4+r.x*.002)*12*devicePixelRatio;t.beginPath(),t.moveTo(r.x-r.l/2,r.y+i),t.bezierCurveTo(r.x-r.l/5,r.y-8*devicePixelRatio,r.x+r.l/5,r.y+8*devicePixelRatio,r.x+r.l/2,r.y-i),t.stroke()}),requestAnimationFrame(o)}requestAnimationFrame(o)}function _d(){let e=document.querySelector(`.scrolly-stage`),t=[...document.querySelectorAll(`.curtain`)].map(e=>{let t=e.querySelector(`.curtain-canvas`),n=e.classList.contains(`curtain-left`)?-1:1,r=new lu({canvas:t,alpha:!0,antialias:!0,powerPreference:`high-performance`});r.setClearColor(0,0),r.outputColorSpace=Re,r.toneMapping=4,r.toneMappingExposure=1.02;let i=new jn,a=new Co(-1,1,1,-1,.01,20);a.position.z=6;let o=new ma(2,2,54,68),s=new Ea({color:new X(`#171113`),roughness:.55,metalness:0,reflectivity:.38,sheen:.72,sheenColor:new X(`#d2d2d7`),sheenRoughness:.48,clearcoat:.1,clearcoatRoughness:.58,side:2,vertexColors:!0}),c=new Zr(o,s);i.add(c);let l=new Eo(1513241,1.45),u=new To(16777215,2.25);u.position.set(n*-1.8,1.2,4.8);let d=new To(10467288,.82);return d.position.set(n*2.5,-.2,3.5),i.add(l,u,d),{el:e,canvas:t,renderer:r,scene:i,camera:a,geometry:o,material:s,mesh:c,side:n,cols:54,rows:68,w:0,h:0,clothW:2,clothH:2,points:[],grabbed:null,collisionEnergy:0,color:new X,temp:new K}}),n={target:0,open:0,velocity:0,shock:0,lastTarget:0,pointerX:window.innerWidth*.5,pointerY:window.innerHeight*.5,prevPointerX:window.innerWidth*.5,prevPointerY:window.innerHeight*.5,pointerVX:0,pointerVY:0,pointerActive:!1,dragging:!1,pull:0};window.__setCurtainOpen=e=>{let t=pd(e);n.shock+=Math.min(.025,Math.abs(t-n.lastTarget)*.045),n.target=t,n.lastTarget=t};function r(e,t,n,r=!1){return{x:e,y:t,z:n,ox:e,oy:t,oz:n,bx:e,by:t,bz:n,pinned:r}}function i(e,t,n){return e.points[n*(e.cols+1)+t]}function a(e){e.points=[];let{cols:t,rows:n,clothW:i,clothH:a,side:o}=e;for(let s=0;s<=n;s++)for(let c=0;c<=t;c++){let l=c/t,u=s/n,d=Math.sin(l*Math.PI*8.2)*.055*(1-u*.3),f=Math.sin(l*Math.PI)*u*u*.055,p=(l-.5)*i+d*o,m=(.5-u)*a-f,h=Math.cos(l*Math.PI*8.2)*.055*(1-u*.24);e.points.push(r(p,m,h,s===0))}}function o(){let e=Math.min(window.devicePixelRatio||1,2);t.forEach(t=>{let n=t.el.getBoundingClientRect();t.w=Math.max(1,Math.round(n.width)),t.h=Math.max(1,Math.round(n.height)),t.clothW=2.35,t.clothH=2.35*(t.h/t.w),t.renderer.setPixelRatio(e),t.renderer.setSize(t.w,t.h,!1),t.camera.left=-t.clothW/2,t.camera.right=t.clothW/2,t.camera.top=t.clothH/2,t.camera.bottom=-t.clothH/2,t.camera.updateProjectionMatrix(),t.mesh.scale.set(t.clothW/2,t.clothH/2,1),a(t)})}function s(e){n.prevPointerX=n.pointerX,n.prevPointerY=n.pointerY,n.pointerX=e.clientX,n.pointerY=e.clientY,n.pointerVX=n.pointerX-n.prevPointerX,n.pointerVY=n.pointerY-n.prevPointerY,n.pointerActive=!0,n.shock+=Math.min(.008,Math.hypot(n.pointerVX,n.pointerVY)*12e-5)}function c(e){let t=e.canvas.getBoundingClientRect(),r=(n.pointerX-t.left)/t.width,i=(n.pointerY-t.top)/t.height;return{inside:n.pointerActive&&r>-.08&&r<1.08&&i>-.08&&i<1.08,x:(r-.5)*e.clothW,y:(.5-i)*e.clothH,u:r,v:i}}window.addEventListener(`pointermove`,s,{passive:!0}),e.addEventListener(`pointerleave`,()=>{n.dragging||(n.pointerActive=!1)}),e.addEventListener(`pointerdown`,r=>{s(r),n.dragging=!0,e.classList.add(`is-pulling`);let i=null,a=1/0;t.forEach(e=>{let t=c(e);e.grabbed=null,e.points.forEach(n=>{if(n.pinned)return;let r=Math.hypot(n.x-t.x,n.y-t.y)+Math.abs(n.z)*.24;r<a&&(a=r,i={curtain:e,point:n,local:t})})}),i&&a<.16&&(i.curtain.grabbed=i.point,n.pull=.22,n.shock+=.018);try{e.setPointerCapture?.(r.pointerId)}catch{}}),e.addEventListener(`pointerup`,r=>{n.dragging=!1,n.shock+=.012,n.pull=0,t.forEach(e=>{e.grabbed=null}),e.classList.remove(`is-pulling`);try{e.releasePointerCapture?.(r.pointerId)}catch{}}),e.addEventListener(`pointercancel`,()=>{n.dragging=!1,n.pull=0,t.forEach(e=>{e.grabbed=null}),e.classList.remove(`is-pulling`)});function l(e,t,n,r=.48){let i=t.x-e.x,a=t.y-e.y,o=t.z-e.z,s=Math.hypot(i,a,o)||1e-4,c=(s-n)/s*r,l=i*c*.5,u=a*c*.5,d=o*c*.5;e.pinned||(e.x+=l,e.y+=u,e.z+=d),t.pinned||(t.x-=l,t.y-=u,t.z-=d)}function u(e,t){let{cols:r,rows:a,clothW:o,clothH:s,side:u}=e,d=c(e),f=Math.min(26,Math.hypot(n.pointerVX,n.pointerVY)),p=n.dragging?.1:.04,m=o/r,h=s/a,g=Math.sin(t*.42+u)*.0018+Math.sin(t*.86)*.001+n.velocity*.045+n.shock*.01;e.collisionEnergy*=.82;for(let c=0;c<=a;c++)for(let l=0;l<=r;l++){let m=i(e,l,c),h=l/r,_=c/a,v=h*Math.PI*(8.2+n.open*.55)+t*.055*u,y=.06*(1-_*.25),b=u*n.open*o*(.055+.04*Math.sin(h*Math.PI))*(1-_*.18);if(m.bx=(h-.5)*o+Math.sin(v)*y*u+b,m.by=(.5-_)*s-Math.sin(h*Math.PI)*_*_*(.07+n.shock*.01),m.bz=Math.cos(v)*(.075+n.open*.01)*(1-_*.15),m.pinned){m.x+=(m.bx-m.x)*.3,m.y+=(m.by-m.y)*.3,m.z+=(m.bz-m.z)*.3,m.ox=m.x,m.oy=m.y,m.oz=m.z;continue}let x=(m.x-m.ox)*.825,S=(m.y-m.oy)*.815,C=(m.z-m.oz)*.8;if(m.ox=m.x,m.oy=m.y,m.oz=m.z,m.x+=x+(m.bx-m.x)*(.01+_*.002)+u*g*_,m.y+=S+(m.by-m.y)*(.008+_*.002)-.0018,m.z+=C+(m.bz-m.z)*.014+g*(.55+_*.22),d.inside){let t=m.x-d.x,n=m.y-d.y,r=Math.hypot(t,n)||1e-4;if(r<p){let i=(p-r)/p,a=t/r,o=n/r;m.x+=a*i*(.0018+f*25e-6),m.y+=o*i*(.0014+f*2e-5),m.z+=i*(.0045+f*55e-6),e.collisionEnergy=Math.max(e.collisionEnergy,i*.15)}}}if(e.grabbed&&n.dragging){let t=e.grabbed;t.x+=(d.x-t.x)*.07,t.y+=(d.y-t.y)*.06,t.z+=(.045-t.z)*.055,t.ox=t.x-n.pointerVX/Math.max(1,e.w)*e.clothW*.018,t.oy=t.y+n.pointerVY/Math.max(1,e.h)*e.clothH*.014,e.collisionEnergy=Math.max(e.collisionEnergy,.12)}for(let t=0;t<7;t++)for(let t=0;t<=a;t++)for(let n=0;n<=r;n++)n<r&&l(i(e,n,t),i(e,n+1,t),m,.66),t<a&&l(i(e,n,t),i(e,n,t+1),h,.64),n<r&&t<a&&l(i(e,n,t),i(e,n+1,t+1),Math.hypot(m,h),.08)}function d(e,t){let{geometry:n,cols:r,rows:a,clothW:o,clothH:s,side:c}=e,l=n.attributes.position,u=n.attributes.color||new ur(new Float32Array(l.count*3),3);n.attributes.color||n.setAttribute(`color`,u);for(let n=0;n<=a;n++)for(let d=0;d<=r;d++){let f=n*(r+1)+d,p=i(e,d,n),m=d/r,h=n/a;l.setXYZ(f,p.x/(o/2),p.y/(s/2),p.z);let g=Math.sin(m*Math.PI*10.5+p.z*10+t*.22*c),_=Math.max(0,Math.sin(m*Math.PI*3.4+p.z*8+.6))**2.4,v=Math.max(0,Math.cos((m-.45*c)*Math.PI*2.2+t*.1))**5,y=Math.min(1,Math.abs(p.z-p.bz)*4.5+e.collisionEnergy*.12),b=.24+g*.035+_*.11+v*.08+y*.04-h*.075;e.color.setRGB(.035+b*.19,.032+b*.17,.036+b*.18),u.setXYZ(f,e.color.r,e.color.g,e.color.b)}l.needsUpdate=!0,u.needsUpdate=!0,n.computeVertexNormals(),e.material.roughness=.54+Math.sin(t*.35)*.01-e.collisionEnergy*.015,e.material.sheenRoughness=.48+e.collisionEnergy*.03,e.renderer.render(e.scene,e.camera)}function f(r){let i=r*.001,a=(n.target-n.open)*.055;n.velocity=(n.velocity+a)*.82,n.open=pd(n.open+n.velocity),n.shock*=.92,n.pointerVX*=.82,n.pointerVY*=.82,n.pull*=.9;let o=Math.max(...t.map(e=>e.collisionEnergy),n.shock),s=Math.sin(i*.72)*.006+Math.sin(i*1.41)*.003,c=pd(n.open+s*(1-n.open)+n.shock*.035);e.style.setProperty(`--curtain-open`,c.toFixed(4)),e.style.setProperty(`--curtain-sway`,(s*8+n.velocity*55+o*3.5).toFixed(3)),e.style.setProperty(`--curtain-pull`,Math.max(n.pull,o).toFixed(4)),t.forEach(e=>{u(e,i),d(e,i)}),window.__curtainPhysicsDebug={mode:`three-cloth`,open:c,energy:o,leftEnergy:t[0]?.collisionEnergy||0,rightEnergy:t[1]?.collisionEnergy||0,grabbed:t.some(e=>!!e.grabbed),points:t.reduce((e,t)=>e+t.points.length,0)},requestAnimationFrame(f)}window.addEventListener(`resize`,o),o(),requestAnimationFrame(f)}function vd(){let e=document.querySelector(`.scrolly`),t=document.querySelector(`.scrolly-stage`),n=[...document.querySelectorAll(`.story-copy`)],r=document.querySelector(`#progress-index`),i=document.querySelector(`#progress-text`),a=[`OPEN`,`REVEAL`,`SUPPORT`,`DETAIL`,`ROOM`,`MATERIAL`,`SPECS`,`NIGHT`];function o(){let o=e.getBoundingClientRect(),s=Math.max(1,o.height-window.innerHeight),c=pd(-o.top/s),l=md((c-.03)/.16),u=md((c-.86)/.13),d=pd(l*(1-u)),f=pd(md((c-.12)/.18)*(1-u*.45)),p=pd(md((c-.18)/.18)*(1-u*.15)),m=md((c-.38)/.12)*(1-md((c-.54)/.1)),h=md((c-.54)/.12)*(1-md((c-.7)/.1)),g=md((c-.61)/.08)*(1-md((c-.74)/.08)),_=md((c-.72)/.08)*(1-md((c-.84)/.07)),v=md((c-.84)/.08),y=pd(md((c-.15)/.28)*(1-u*.55));t.style.setProperty(`--open`,d.toFixed(4)),t.style.setProperty(`--room`,f.toFixed(4)),t.style.setProperty(`--pillow`,p.toFixed(4)),t.style.setProperty(`--corner`,m.toFixed(4)),t.style.setProperty(`--return`,h.toFixed(4)),t.style.setProperty(`--material-phase`,g.toFixed(4)),t.style.setProperty(`--spec-phase`,_.toFixed(4)),t.style.setProperty(`--order-phase`,v.toFixed(4)),t.style.setProperty(`--final`,u.toFixed(4)),t.style.setProperty(`--glow`,y.toFixed(4)),window.__setPillowScroll?.({p:c,pillow:p,corner:m,returnPhase:h,final:u}),window.__setCurtainOpen?.(d);let b=Math.min(7,Math.floor(pd(c*8.15,0,7.999)));n.forEach((e,t)=>e.classList.toggle(`active`,t===b)),r.textContent=`${String(b+1).padStart(2,`0`)}`,i.textContent=a[b]}window.addEventListener(`scroll`,o,{passive:!0}),window.addEventListener(`resize`,o),o()}function yd(){let e=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`is-visible`)})},{threshold:.16});document.querySelectorAll(`[data-reveal]`).forEach(t=>e.observe(t))}hd(),gd(),_d(),vd(),yd();